...
% folloiwng.
tic
addpath 'C:\Toolbox\fieldtrip-20220812'
...
rootpathData = uigetdir('C:\Users\se16008969\Desktop\Job\Ulster University\ISRC Autumn School\Neuro and Connectivity\Day-3-27-10-main\Lab\Girijesh Prasad\Dataset\', ['Go to your downloaded path and then ' ...
    'select Girijesh Prasad\Dataset\']);
...
chansel_option = 'mag'; %('all'-all channels (306), 'grad'- gradiometers (204), 'mag'-magnetometers (102))
