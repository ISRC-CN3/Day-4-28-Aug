...
if exist('rootpathData')
    pathdatain = uigetdir(rootpathData, ['Go to your downloaded path and then ' ...
        'select Girijesh Prasad\Dataset\DataMEG_matFeatures\MuBeta']);
else
    pathdatain = uigetdir('C:\', ['Go to your downloaded path and then ' ...
        'select Girijesh Prasad\Dataset\DataMEG_matFeatures\MuBeta']);
end
